...
OBJECT_LIST = assembler.o compilation.o pre_processor.o utility_functions.o identification.o error_handling.o analysis.o
...
analysis.o: analysis.c analysis.h $(GLOBAL_HELPER)
	$(CC) $(CFLAGS) -c analysis.c -o $@
